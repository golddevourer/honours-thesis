    ...
    def step(self, mcs):
        ...
        for cell in self.cell_list:
            ...
            if cell.type==2: 
                ...
                for neighbor, common_surface_area in self.get_cell_neighbor_data_list(cell):
                    if neighbor:
                        if neighbor.type==1:
                            ...
                            for second_neighbor, surface_area in self.get_cell_neighbor_data_list(neighbor):
                                if second_neighbor:
                                    if second_neighbor.type==1:
                                        acid=True
                                        break
                if acid:
                    if random.random()<D2:
                ...
                elif random.random()<D1:
                    cell.targetVolume = 0 #Starts apoptosis
                    cell.lambdaVolume = 200 #Optional: make the shrinkage happen very fast
            if cell.type==1 and random.random()<D1:
